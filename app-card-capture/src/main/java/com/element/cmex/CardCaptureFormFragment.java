...
public class CardCaptureFormFragment extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_card_capture_form, container, false);
    ...
    public void setMainActivity(final CmMainActivity activity) {
