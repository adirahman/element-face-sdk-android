...
public class SpResultFragment extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_fm_result, container, false);
        ...
        retryButton.setVisibility(getActivity() instanceof SpAuthActivity ? View.VISIBLE : View.GONE);
        retryButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (getActivity() instanceof SpAuthActivity) {
                    ((SpAuthActivity) getActivity()).recapture();
                }
            }
        });
